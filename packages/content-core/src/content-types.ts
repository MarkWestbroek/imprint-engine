...
const t = (label: string, flags: ContentTypeFlag[]): ContentTypeInfo => ({
  label,
...
export const CONTENT_TYPES = {
  page: t("Pages", ["listable", "editable", "ingestable", "overview"]),
  product: t("Products", ["listable", "editable", "ingestable", "overview"]),
  component: t("Components", ["listable", "editable", "ingestable", "overview"]),
  "board-spec": t("Board specs", ["listable", "editable", "ingestable", "overview"]),
  release: t("Releases", ["listable", "editable", "ingestable", "overview"]),
  ...
  menu: t("Menus", ["listable", "editable", "overview"]),
  theme: t("Themes", ["listable", "editable", "overview"]),
  site: t("Site", ["listable", "editable"]),
