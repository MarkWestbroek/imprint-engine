...
| 5 — Eerste echte plugins | **bezig**: stap 1–4 klaar — contenttyperegister, plugincontract met drie haken, `@imprint/plugin-planning` en `@imprint/plugin-wiki` aan in MusicBrain met één regel elk; de kern kent geen van beide meer. Rest: stap 5, de exitproef op de Imprint-site. Ontwerp in [fase-5-plugins.md](fase-5-plugins.md) | |
| 6 — Hardening | open | |
