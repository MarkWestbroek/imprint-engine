...
| 2 — Renderer en standard widgets | **bezig**: stap 2 van 5 klaar. Renderer vastgelegd in golden HTML (`933de2c`); renderer en layouthelpers verhuisd naar `@imprint/runtime-admin` | backlog; architecture.md §3 en §8 |
