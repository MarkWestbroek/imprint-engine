...
| 3 — Generieke adminbasis | **bezig**; ontwerp en besluiten vastgelegd, open vragen in §11.3 daarvan. Stap 1 klaar: gebruikers op Postgres, secrets via de config, contenttypecatalogus beschikbaar/actief. Stap 2 klaar: browsertests van alle admin-flows (22, productie en dev). Volgende: stap 3, het poortje in AuthZEN-vorm | [fase-3-admin-toegang-tijdreizen.md](fase-3-admin-toegang-tijdreizen.md) |
