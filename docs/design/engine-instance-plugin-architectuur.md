...
| 3 — Generieke adminbasis | **volgende**; ontwerp en besluiten vastgelegd, open vragen in §10 daarvan | [fase-3-admin-toegang-tijdreizen.md](fase-3-admin-toegang-tijdreizen.md) |
