...
| 3 — Generieke adminbasis | **bezig**; ontwerp en besluiten vastgelegd, open vragen in §11.3 daarvan. Stap 1 klaar: gebruikers op Postgres, secrets via de config, contenttypecatalogus beschikbaar/actief. Stap 2 half: browsertest-infrastructuur met login, lijst en studio-rooktest; opslaan, historie, herstel en gebruikers volgen | [fase-3-admin-toegang-tijdreizen.md](fase-3-admin-toegang-tijdreizen.md) |
