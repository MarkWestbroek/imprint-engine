...
| 3 — Generieke adminbasis | **bezig**; ontwerp en besluiten vastgelegd, open vragen in §11.3 daarvan. Stap 1 klaar: gebruikers op Postgres, secrets via de config, contenttypecatalogus beschikbaar/actief. Volgende: stap 2, de browsertest | [fase-3-admin-toegang-tijdreizen.md](fase-3-admin-toegang-tijdreizen.md) |
